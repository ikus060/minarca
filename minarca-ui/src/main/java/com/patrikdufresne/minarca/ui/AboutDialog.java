...
public class AboutDialog extends Dialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        appCopyrightText.setText(API.getCopyrightText());
        ...
        appWebSite.setText("<a>Minarca (https://www.ikus-soft.com/en/minarca/)</a>"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        appWebSite.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                Program.launch("https://www.ikus-soft.com/");
            }
        });
