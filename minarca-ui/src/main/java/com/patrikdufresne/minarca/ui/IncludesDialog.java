    ...
    private ICheckStateProvider createCheckStateProvider() {
        return new ICheckStateProvider() {
            ...
            public boolean isChecked(Object element) {
                ...
                return isExcluded((File) element) == null && (isIncluded((File) element) != null || containsInclude((File) element));
            }
        ...
        return new StyledCellLabelProvider() {
            ...
            StyledString.Styler styler = new StyledString.Styler() {
                ...
                public void applyStyles(TextStyle textStyle) {
                    textStyle.foreground = Display.getCurrent().getSystemColor(SWT.COLOR_WIDGET_NORMAL_SHADOW);
                    textStyle.font = AppFormToolkit.getFontItalic(JFaceResources.DIALOG_FONT);
                }
