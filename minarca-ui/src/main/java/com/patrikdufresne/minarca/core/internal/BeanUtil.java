...
public class BeanUtil {
	 ...
	 */
	static void getInterfacePropertyDescriptors(List propertyDescriptors,
			Class iface) throws IntrospectionException {
	...
	public static Object readProperty(Object source, String propertyName) {
		PropertyDescriptor property = getPropertyDescriptor(source.getClass(),
				propertyName);
		if (property == null) {
	 ...
	 * @throws IllegalArgumentException
	 */
	public static void writeProperty(Object source, String propertyName,
