...
<SidePanel>:
    ...
    CBoxLayout:
        ...
        CLabel:
            ...
            font_size: "60dp"
            text_color: app.primary if root.step == 1 else app.dark

        CLabel:
            text: "\u2022"
            theme_font_size: "Custom"
            font_size: "60dp"
            text_color: app.primary if root.step == 2 else app.dark

        CLabel:
            text: "\u2022"
            theme_font_size: "Custom"
            font_size: "60dp"
            text_color: app.primary if root.step == 3 else app.dark
'''
)
