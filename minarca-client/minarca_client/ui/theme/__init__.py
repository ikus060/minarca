...
<CButton>:
    ...
    -padding: "0dp" if self.style == 'text' else {'small': ("15dp", "8dp"), 'medium': ("22dp", "12dp"), 'large': ("22dp", "12dp")}.get(root.role)
...
<CTextField>:
    ...
    line_color_normal: app.gray_20
    line_color_focus: app.primary
    write_tab: False
    multiline: False

    MDTextFieldHintText:
        text: root.name
        text_color_normal: app.gray_20
...
<MDSwitch>:
    ripple_effect: False
    #track_color_active: app.primary
...
class CSpinner(MDCircularProgressIndicator):
    pass
...
class CListItemText(MDListItemSupportingText):
    pass
