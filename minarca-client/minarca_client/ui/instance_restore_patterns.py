...
class InstanceRestorePatternsView(MDBoxLayout):
    ...
    def _fetch_patterns(self):
        asyncio.get_event_loop().create_task(self._fetch_patterns_task())
    ...
    async def _fetch_patterns_task(self):
        ...
        try:
            ...
            await asyncio.get_event_loop().run_in_executor(None, backup.restore, None, patterns)
