    ...
    MDRelativeLayout:
        ...
        MDBoxLayout:
            ...
            CCard:
                ...
                CLabel:
                    text: _("No external disk detected for data backup. Plug your external disk and click the refresh button.")
                    size_hint_x: 1
                    halign: "center"
...
class BackupConnectionLocal(MDBoxLayout):
    ...
    def refresh_removable_disks(self):
        ...
        self._refresh_removable_disks_task = asyncio.get_event_loop().create_task(self._refresh_removable_disks())
    ...
    def select_custom_disk(self):
        ...
        self._select_custom_disk_task = asyncio.get_event_loop().create_task(_select_custom_disk())
    ...
    def save(self, event=None):
        ...
        # Start creation task.
        self.working = True
        self._create_local_task = asyncio.get_event_loop().create_task(
