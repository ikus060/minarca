...
class BackupSettings(MDBoxLayout):
    ...
    # TODO complete this for Windows
    ...
    async def _load(self):
        try:
            ...
            await asyncio.get_event_loop().run_in_executor(None, self.instance.load_remote_settings)
    ...
    def save(self):
        if self.working:
            ...
            return
        self.working = True
        self._save_task = asyncio.get_event_loop().create_task(self._save())
    ...
    async def _save(self):
        try:
            ...
            if self.instance.is_remote():
                ...
                wait = self.create
                await asyncio.get_event_loop().run_in_executor(None, self.instance.save_remote_settings, wait)
