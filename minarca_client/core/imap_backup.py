...
from .exceptions import IMAPListFolderError
...
def parse_args(args):
    ...
    parser.add_argument('--exclude-folder', action='append', help='Glob pattern to exclude folders', default=["?Gmail*"])
...
def main_run(args):
    ...
    try:
        ...
        # FIXME We should take care of BackupError with error code.
