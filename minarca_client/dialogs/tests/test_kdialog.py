...
from minarca_client.dialogs._dialogs_linux_kdialog import (
    error_dialog,
    file_dialog,
    folder_dialog,
    info_dialog,
...
@unittest.skipIf(not (IS_LINUX and DISPLAY and KDIALOG), 'required Linux, a display and kdialog')
class KDialogMainDialogTest(AbstractDialogTest, unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        super().setUp()
